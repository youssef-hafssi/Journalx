...
const Index = () => {
  ...
  // Reset scrollPosition when it completes a full cycle
  useEffect(() => {
    if (scrollPosition >= (100 / reviews.length)) {
      setScrollPosition(0);
    }
  }, [scrollPosition, reviews.length]);
              ...
              <div className="overflow-hidden">
                ...
                >
                  ...
                  {[...reviews, ...reviews, ...reviews].map((review, index) => (
                    <div key={`${review.name}-${index}`} className="w-[220px] flex-shrink-0 px-2">
                      <Card 
